...
This directory contains Architecture Decision Records (ADRs) for [Your Project Name]. ADRs are used to document important architectural decisions, their context, and consequences.
